                                ...
                                <div id="tab-emergency-setting" class="tab-pane fade">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                @foreach(App\EmployeeRelative::where("user_id",Auth::id())->get() as $u)
                                                <tr class="empRel text-center" data-id="{{$u->id}}" data-name="{{ $u->full_name }}" data-phone="{{ $u->phone_number }}" data-depd="{{ $u->is_dependent }}" data-address="{{ $u->address }}" data-rel="{{$u->relation}}">
                                                    <td>{{ $u->full_name }}</td>
                                                    <td>{{ $u->phone_number }}</td>
                                                    <td>{{ $u->is_dependent==null?"No":"Yes" }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        ...
                                        <div class="form-horizontal emprel-contain" style="display: none">
                                            <form action="profile/emprel/" id="emprel-form" method="POST">
                                                {{ csrf_field() }}
                                            ...
                                            <div class="form-group"><label
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <input type="text" id="rel-name" placeholder="Nhập Họ Tên" name="name_relative" class="form-control" value="" />
                                                </div>
                                            </div>
                                            <div class="form-group"><label
                                                ...
                                                <div class="col-sm-9 controls">
                                                     <input id="rel-address" class="form-control" rows="3" name="address_relative" placeholder="Nhập Địa Chỉ"/>
                                                </div>
                                            </div>
                                            <div class="form-group"><label
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <input type="text" id="rel-rel" placeholder="Nhập Mối Quan Hệ" name="relationship_relative" class="form-control" value=""/>
                                                </div>
                                            </div>
                                            <div class="form-group"><label
                                                    class="col-sm-3 control-label">Phụ Thuộc</label>

                                                <div class="col-sm-9 controls">
                                                    <select name="is_dependent" id="rel-depd">
                                                        <option value="1">
                                                            Yes
                                                        </option>
                                                        <option value="">
                                            ...
                                            <div class="form-group"><label
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <input type="text" id="rel-phone" placeholder="Nhập Số Điện Thoại" class="form-control" name="phone_number_relative" value=""/>
                                                </div>
                                            </div>
                                            <div class="form-group mbn"><label
                                                    class="col-sm-3 control-label"></label>
